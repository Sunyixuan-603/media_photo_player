#ifndef __LCD_JPEG_H__
#define __LCD_JPEG_H__
...
int jpeg_control_display(unsigned int x,unsigned int y,unsigned int height,unsigned int weight,const char *pjpg_path);
int mmap_lcd(void);
int lcd_open(void);
#endif